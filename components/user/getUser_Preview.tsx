                ...
                <div className="flex flex-col relative ">
                    ...
                    <div>
                        ...
                        <>
                            ...
                            <Link href="https://www.facebook.com/Novacore">
                            ...
                            <Link href="https://www.tiktok.com/@Mashwishi">
                            ...
                            <Link href="https://discord.gg/ctn6EsKejZ">
                            ...
                            <Link href="https://www.facebook.com/Mashwishi">
                            <div className="bg-[#4267B2] mx-4 mt-4 py-2 px-4 rounded-t-[15px] rounded-b-[15px] relative cursor-pointer">
                                <div className="flex flex-row items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="bi bi-facebook" viewBox="0 0 16 16">
                                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                            ...
                            <Link href="https://twitter.com/Mashwishi">
                            ...
                            <Link href="https://www.twitch.tv/Mashwishiii">
                            ...
                            <Link href="https://github.com/Mashwishi">
                    ...
                    {/*Rating Signout*/}
                    <div className="bg-[url('/banner-1.png')] bg-cover bg-[#657EF8]  mb-6 mx-4 mt-4 p-5 rounded-t-[15px] rounded-b-[15px] relative mb-8">
...
export default GetUser_Preview;
