        ...
        <div className="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            <div className="w-full md:w-1/2 md:px-3">
                ...
                <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-5xl">
                    ...
                    <span className="block text-indigo-600 xl:inline">Create</span>
                    <span className="block xl:inline"> your link profile in minutes!</span>
                ...
                <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                    ...
                    <button onClick={() => openSignIn()} className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-indigo-600 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
                    Get Started 
